...
function campus() {
  ...
  it("should add / edit / delete Campus", () => {
    ...
    cy.findByRole("textbox", { name: /campus name/i }).clear().type(BEFORE_CAMPUS_NAME)
    ...
    cy.findByRole("textbox", { name: /campus name/i }).clear().type(AFTER_CAMPUS_NAME)
    cy.findByRole("button", { name: /save/i }).click()
...
function service() {
  ...
  it("should add / edit / delete a Service", () => {
    ...
    cy.findByRole("textbox", { name: /service name/i }).clear().type(BEFORE_SERVICE_NAME)
    cy.wait(2000)
    ...
    cy.findByRole("textbox", { name: /service name/i }).clear().type(AFTER_SERVICE_NAME)
    cy.wait(2000)
    cy.findByRole("combobox", { name: /campus/i }).select(CAMPUS_NAME)
    cy.findByRole("button", { name: /save/i }).click()
...
function serviceTime() {
  ...
  it("should add / edit / delete Service Time", () => {
    ...
    cy.findByRole("textbox", { name: /service time name/i }).clear().type(BEFORE_SERVICE_TIME)
    cy.wait(2000)
    ...
    cy.findByRole("textbox", { name: /service time name/i }).clear().type(AFTER_SERVICE_TIME)
    cy.wait(2000)
    cy.findByRole("combobox", { name: /service/i }).select(SERVICE_NAME)
    cy.findByRole("button", { name: /save/i }).click()
